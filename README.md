...
1.4.0.0 the field is anchored on where the form **posts to** (`…/user/register`), which no theme
...
próprio formulário: o `id` e as classes do núcleo podem não existir. Desde a 1.4.0.0 o campo é
